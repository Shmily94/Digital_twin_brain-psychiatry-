function [sub_antici_hit,sub_feed_hit,sub_feed_miss,sub_mid_subject] = xic_mid_data2(files)


sub_antici_hit = zeros(217,217,length(files));
sub_feed_hit = zeros(217,217,length(files));
sub_feed_miss = zeros(217,217,length(files));
...
sub_mid_subject=antici_hit_subject;
