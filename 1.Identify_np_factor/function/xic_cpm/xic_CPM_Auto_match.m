...
CPM_Result = xic_CPM_both(data1,pynotype1,thresh);
CPM_Result.subject = a;
[CPM_mask] = xic_CPM_mask(data1,CPM_Result);
...
CPM_Result = xic_CPM_both(data2,pynotype2,thresh);
CPM_Result.subject = a;
[CPM_mask] = xic_CPM_mask(data2,CPM_Result);
...
CPM_Result = xic_CPM_both(data3,pynotype3,thresh);
CPM_Result.subject = a;
[CPM_mask] = xic_CPM_mask(data3,CPM_Result);
