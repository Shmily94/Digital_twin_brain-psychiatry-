...
function xic_CPM_Auto_elastic_net(phenotype,phenotype_name,phenotype_subject,thresh,nfold)
...
CPM_Result = xic_CPM_both_elastic_net(all_mats,all_behav,thresh,nfold);
