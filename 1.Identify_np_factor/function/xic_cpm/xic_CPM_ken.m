...
function [CPM_Result] = xic_CPM_ken(all_mats_set,all_behav_set,thresh_set)
...
parfor leftout = 1:no_sub
    ...
    [r_mat,p_mat] = corr(train_mats,train_behav,'type','Spearman');
    r_mat(isnan(r_mat))= 0;
    p_mat(isnan(p_mat))= 0;
...
[R_pos, P_pos] = corr(behav_pred_pos,test,'type','Spearman');
[R_neg, P_neg] = corr(behav_pred_neg,test2,'type','Spearman');
