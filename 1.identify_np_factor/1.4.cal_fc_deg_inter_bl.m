...
%% calculate fc degree in internalizing for bl  
clear;clc;close all
...
name = {'SST_stopsuccess','SST_stopfailure','SST_gowrong',...
 ...
 % load('/public/home/xic_fdu/Finished_project/2019_NP_factor/IAMGEN_Develop_diagnostic_0814/MyColormaps.mat')
...
for k= 1:4
    ...
    models = dir(fullfile('D:\postdoc\Work\Computer-Brain-Project\Results\Baseline\CPM_results\XIC_shen_results\BL_Models\',['*',model_name{model(k)}]));
        ...
        for j=5:8
            ...
            if  R_value1 > 0.02 && R_value2 > 0.02
             ...
             if i~=j 
                ...
                nums_pos(i-4,j-4) = sum(sum(pos_pos_net));
                nums_neg(i-4,j-4) = sum(sum(neg_neg_net));
...
save inter_pp_nn_degree.mat share_pp share_pp_degree1 share_nn share_nn_degree1
