...
%% Predict performance
%% BASELINE Predict Performance

clear;clc;
addpath('D:\postdoc\Work\Computer-Brain-Project\Code\CPM\IAMGEN_Develop_diagnostic_0814\Trans_diagnostic_p_facotr')

cd('D:\postdoc\Work\Computer-Brain-Project\Results\Followup2\CPM_Models_discard_contro2\CPM_results\')
...
save FU2_R_predict_perform.mat  R_predict_pos R_predict_neg ...
                       R_predict_both 
...
path_model = 'D:\postdoc\Work\Computer-Brain-Project\Results\Followup2\CPM_Models_discard_contro2';
...
% load('D:\postdoc\Work\Computer-Brain-Project\Code\IAMGEN_Develop_diagnostic_0814\Trans_diagnostic_p_facotr\MyColormaps.mat')
%%BL
% number=[4 2 5 7 3 1 6 8];
% dis_names  = {'asd','adhd','cd' ,'od','anxiety','dep','eat','speph'};
...
conditions = [1 2 3 4 5 6];%1 2 5 6
...
save A2_1_1_Network_P_factor_0927.mat same_way_all oppo_way_all neg_pos_all_dimension neg_neg_all_dimension ...
